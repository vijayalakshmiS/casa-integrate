...
// 	console.log("get");
// 	var id = req.param('id');
// 	Entity.where({ id : id }).fetch({ withRelated: ['fields'] }).then(function(entity){
// 		res.json(entity);
// 	}).catch(function(err){
// 		console.log(err);
// 	})
...
router.get('/',function(req, res){
	console.log("get");
	Entity.fetchAll({ withRelated: ['fields'] }).then(function(entity){
		res.json(entity);
	}).catch(function(err){
		console.log(err);
	})
...
router.post('/', jsonParser, function(req, res){
	...
	new Entity(req.body).save().then(function(createEntity){
...
router.put('/:id', function(req, res){
	...
	var id = req.param('id');
	var name = req.param('name');
	Entity.where({ id : id }).fetch().then(function(table){
